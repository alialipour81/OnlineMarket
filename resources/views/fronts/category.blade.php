            ...
            <div class="row">
                <div class="profile-page col-xl-12 col-lg-12 col-md-12 order-2">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-12">
                                <h1 class="title-tab-content">دسته بندی {{$category->name}}</h1>
                            </div>
                            <div class="content-section default">
                                <div class="row">
                                    ...
                                    @empty
                                        <div class="alert alert-success pb-4 form-control rounded">محصولی برای این دسته بندی فعلا موجود نیست</div>
                                    @endforelse
                                </div>
                            </div>
                        </div>
