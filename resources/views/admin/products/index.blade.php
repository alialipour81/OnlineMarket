...
@section('content')
    ...
    <div class="card card-default" dir="rtl">
        <div class="card-header d-flex justify-content-between">
            ...
            <a href="{{ route('products.create') }}" class="btn btn-danger btn-sm  float-left">افزون محصول</a>
        </div>
        <div class="card-body">
            <table class="table table-borderless text-center">
               ...
               @foreach($products as $product)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('collapses.index2',$product->id) }}" class="btn btn-secondary btn-sm">افزودن</a>
                        </td>
                        <td>
